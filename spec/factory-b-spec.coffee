...
describe 'Factory B', ->
  ...
  describe 'has a get method that', ->
    ...
    it 'should accept a string as a key and a JSON object as mutator and reuturn an altered JSON object', ->
      originalJson =
        ice: 'cold'
        fire: 'fire'
      json =
    ...
    it 'should accept a JSON object as a mutator and return the JSON object under the default key altered', ->
      originalJson =
        ice: 'cold'
        fire: 'fire'
      json =
  ...
  describe 'has a set method that', ->
    ...
    it 'should accept a JSON object that will be retrievable with the key default', ->
      json = fur: 'existential'
      bee = new FactoryB
      bee.set(json)
      result = bee.get()
